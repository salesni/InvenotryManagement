...
public class ResourcesServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/api/detalles/newDetalle").hasAnyRole("SELLER","ADMIN")
		.antMatchers("/api/detalles/**").hasRole("ADMIN")
		.antMatchers("/api/inventario/**").hasAnyRole("ADMIN","MANAGER")
		.antMatchers("/api/ticket/newTicket").hasAnyRole("SELLER","ADMIN")
		.antMatchers("/api/ticket/**").hasRole("ADMIN")
		.antMatchers("/api/ticketLogic/newTicket").hasAnyRole("SELLER","ADMIN")
		.antMatchers("/api/ticketLogic/**").hasRole("ADMIN")
